...
public class MediaController extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    public void initTrimmedMode() {
        ...
        mExpandImg.setVisibility(VISIBLE);
    ...
    public void setExpandClickListener(OnClickListener listener){
        if(mExpandImg != null && listener != null)mExpandImg.setOnClickListener(listener);
    }
