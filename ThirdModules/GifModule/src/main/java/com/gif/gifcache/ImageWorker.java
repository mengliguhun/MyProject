...
public class ImageWorker {
    ...
    public void loadImage(Object data, ImageView imageView, int resId,OnImageLoadedListener listener) {
        ...
        if (cancelPotentialWork(data, imageView)) {
            ...
            if (resId>0){
                ...
                final BitmapWorkerTask task = new BitmapWorkerTask(data, imageView,bitmap,listener);
    ...
    public void loadImage(Object data, ImageView imageView) {
        loadImage(data, imageView,0, null);
    }
    /**
     * Load an image specified by the data parameter into an ImageView (override
     * disk cache will be used if an {@link ImageCache} has been added using
    ...
    private class BitmapWorkerTask extends AsyncTask<Void, Void, Drawable> {
        ...
        public BitmapWorkerTask(Object data, ImageView imageView,Bitmap bitmap,OnImageLoadedListener listener) {
            mBitmap = bitmap;
            mData = data;
        ...
        protected Drawable doInBackground(Void... params) {
            ...
            if (bytes == null && mImageCache != null && !isCancelled() && getAttachedImageView() != null
                    && !mExitTasksEarly) {
            ...
            if(!(mData instanceof String)){
                ...
                InputStream inputStream =mResources.openRawResource((Integer) mData);
                if (inputStream != null) {
                    try {
        ...
        protected void onPostExecute(Drawable value) {
            ...
            if (value != null && imageView != null) {
                ...
                setImageDrawable(imageView, value,mBitmap);
     ...
     * @param drawable
     */
    private void setImageDrawable(ImageView imageView, Drawable drawable,Bitmap bitmap) {
     ...
     * @param imageView
     */
    public void releaseImageViewResouce(Object imageView) {
