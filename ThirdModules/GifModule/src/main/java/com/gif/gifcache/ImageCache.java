...
public class ImageCache {
    ...
    private static final String DEFAULT_DISK_CACHE_DIR = "files";
        ...
        if (mCacheParams.memoryCacheEnabled) {
            ...
            mMemoryCache = new LruCache<String, byte[]>(mCacheParams.memCacheSize) {
                ...
                protected int sizeOf(String key, byte[] value) {
                    final int bitmapSize = value.length / 1024;
     ...
     */
    public void addBitmapToCache(String data, byte[] value) {
     ...
     */
    public byte[] getBitmapFromMemCache(String data) {
        ...
        if (Utils.DEBUG_MODE && memValue != null) {
     ...
     */
    public byte[] getBitmapFromDiskCache(String data) {
    ...
    public static class ImageCacheParams {
        ...
        public ImageCacheParams(Context context) {
            diskCacheDir = getDiskCacheDir(context, DEFAULT_DISK_CACHE_DIR);
        }
