...
public class PathAnimaton extends Animation{
	 private int mFromXType = ABSOLUTE;
	     ...
	     */
	    public PathAnimaton(float fromXDelta, float toXDelta,
	     ...
	     *            ABSOLUTE, or a percentage (where 1.0 is 100%) otherwise.
	     */
	    public PathAnimaton(int fromXType, float fromXValue, int toXType,
	    ...
	    public void initialize(int width, int height, int parentWidth,
	        ...
	        mControl = new PointF(mToXDelta+300, mFromYDelta -300); // How to choose the
